    ...
    <div className="p-5 lg:p-8 my-8 border-2 rounded-2xl">
      <div className="flex lg:flex-row flex-col gap-6">
        ...
        <div className="flex items-center">
          <figure className="bg-base-200 rounded-2xl w-full flex justify-center py-10">
            <img
              src={image}
        ...
        <div className="lg:w-3/4 w-full">
          <h1 className="text-2xl lg:text-3xl lg:mb-4  font-bold play">
            {bookName}
          </h1>
          <p>
          ...
          <div className="flex lg:flex-row flex-col lg:gap-10">
            <div className="flex flex-wrap items-center gap-4  font-semibold lg:my-4">
              <p>Tags:</p>
          ...
          <div>
            <div className="flex flex-col lg:flex-row gap-4 mt-4">
              <p className="p-3 bg-sky-200   text-blue-600 rounded-3xl">
                Category: {category}
              </p>
              <p className="p-3 bg-sky-200  text-blue-600 rounded-3xl">
                Rating: {rating}
