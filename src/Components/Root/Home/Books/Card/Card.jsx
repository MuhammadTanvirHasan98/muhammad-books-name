     ...
     {/* Cards Info */}
      <div className="mt-6">
        <div className="flex gap-4 mb-4"> 
          <p className="bg-green-50 p-2 rounded-xl font-semibold text-green-600">{tags[0]}</p>
          <p className="bg-green-50 p-2 rounded-xl font-semibold text-green-600">{tags[1]}</p>
        </div>
        <h2 className="lg:text-2xl text-xl font-bold play mb-3">{bookName}</h2>
        <p>By: <span className="font-semibold">{author}</span> </p>

        <hr className="border-dashed border-green-700 w-[95%] mx-auto my-4" />
